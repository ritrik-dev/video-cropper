    ...
    <>
      <Box className="source-video">
        <Box className="video-container container">
          <Box className="video">
            <video
              ...
              onPlaying={(e) => {console.log("e >>", e)}}
              onTim
            >
              <source src="/video/video-1.mp4" />
            </video>
            {cropMode ? <Cropper aspectRatio={aspectRatio} cropMode={cropMode} /> : null}
          </Box>
        </Box>
        ...
        <IconButton
          ...
          >
            {volume > 5 ? <VolumeUpOutlinedIcon /> : volume === 0 ? <VolumeOffOutlinedIcon /> : <VolumeDownOutlinedIcon />}
          </IconButton>
        <Slider
            className="volume-slider"
            size="small"
